...
let colecciones = {
    olivos: { tipo: 'string', año: 'number',posicion: 'string',tipo_aceituna: 'string' },
    clientes: { nombre: 'string', apellidos: 'string',lugar_residencia: 'string',cortijo: 'string' }
};

let index = `
     <div style="margin: 50px">
         <h1>Gestion Olivar</h1>
...
window.addEventListener('load', function () {
    ...
    let a = document.getElementById('olivos');
